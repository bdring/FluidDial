...
private:
    // Default to ones position for M5, and tenths position for CYD due to larger number of pulses generated by encoder handwheels
#ifdef USE_M5
    static const int DEFAULT_DIST_INDEX = 2;  // ones
#else
